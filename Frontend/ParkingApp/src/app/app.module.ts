...
import {AccountStorageService} from './services/account/session-storage.service';
...
// Modals
const MODALS = [NgbdModalConfirmComponent, NgbdModalConfirmAutofocusComponent];
...
@NgModule({
    declarations: [
        ...
        ...FORMS, // account forms
        ...ERRORS,
        AccountEditModalFormComponent, // errors
    ],
