...
public class ColorConsoleOutput {
    ...
    public static @NotNull String ywTxt(String str) {
        return drawColorString(str, YELLOW);
    }

    public static @NotNull String ywBrTxt(String str) {
        return drawColorString(str, YELLOW_BRIGHT);
    }

    public static @NotNull String grTxt(String str) {
        return drawColorString(str, GREEN);
    }

    public static @NotNull String grBrTxt(String str) {
        return drawColorString(str, GREEN_BRIGHT);
    }

    public static @NotNull String blTxt(String str) {
        return drawColorString(str, BLUE);
    }

    public static @NotNull String cyBrTxt(String str) {
        return drawColorString(str, CYAN_BRIGHT);
    }

    public static @NotNull String puBrTxt(String str) {
        return drawColorString(str, PURPLE_BRIGHT);
    }

    public static @NotNull String redTxt(String str) {
        return drawColorString(str, RED);
    }

    public static @NotNull String redBrTxt(String str) {
        return drawColorString(str, RED_BRIGHT);
    }

    public static @NotNull String whTxt(String str) {
     ...
     */
    private static @NotNull String drawColorString(String str, String textColor) {
     ...
     * @return colorized output string
     */
    private static @NotNull String drawColorStringBg(String str, String textColor, String bgColor) {
     ...
     */
    public static @NotNull String methodMsg(String msg) {
     ...
     * @return edited log message string
     */
    public @NotNull String classMsg(String className, String msg) {
