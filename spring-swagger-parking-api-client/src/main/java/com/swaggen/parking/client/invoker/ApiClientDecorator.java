...
import com.swaggen.parking.client.invoker.auth.ApiKeyAuth;
import com.swaggen.parking.client.invoker.auth.Authentication;
import com.swaggen.parking.client.invoker.auth.HttpBasicAuth;
import com.swaggen.parking.client.invoker.auth.OAuth;
...
@Component("com.swaggen.parking.client.invoker.ApiClient")
public class ApiClientDecorator {
    ...
    public ApiClientDecorator() {
        this.restTemplate = buildRestTemplate();
        init();
    }

    @Autowired
    public ApiClientDecorator(RestTemplate restTemplate) {
     ...
     */
    public ApiClientDecorator setBasePath(String basePath) {
     ...
     * @return ApiClient this client
     */
    public ApiClientDecorator setUserAgent(String userAgent) {
     ...
     * @return ApiClient this client
     */
    public ApiClientDecorator addDefaultHeader(String name, String value) {
     ...
     * @return API client
     */
    public ApiClientDecorator setDateFormat(DateFormat dateFormat) {
