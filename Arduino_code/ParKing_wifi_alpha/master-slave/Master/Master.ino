                ...
                if (status_of_lot != last_known_status[i]) {
                    if (status_of_lot == "F") {
                        client.send(msg + String(slave_id) + String(sensor_id) + String("\", \"status\":\"") +
                                    String("FREE") + String("\", \"secure_key\":\"") + security_token + String("\"}"));
                    } else if (status_of_lot == "O") {
                        client.send(msg + String(slave_id) + String(sensor_id) + String("\", \"status\":\"") +
                                    String("OCCUPIED") + String("\", \"secure_key\":\"") + security_token + String("\"}"));
                    } else {
                        client.send(msg + String(slave_id) + String(sensor_id) + String("\", \"status\":\"") +
                                    String("UNKNOWN") + String("\", \"secure_key\":\"") + security_token + String("\"}"));
                    }
                }
