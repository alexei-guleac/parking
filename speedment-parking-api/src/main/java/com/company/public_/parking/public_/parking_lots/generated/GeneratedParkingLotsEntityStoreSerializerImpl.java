...
/**
 * Serializes and deserializes instances of ParkingLots.
 * <p>
...
public abstract class GeneratedParkingLotsEntityStoreSerializerImpl implements EntityStoreSerializer<ParkingLots> {
    ...
    private static final int ENDPOS_STATUS = 9;
    private static final int ENDPOS_UPDATED_AT = 10;
    private static final int VARSIZE_BEGINS = 11;
    
    protected GeneratedParkingLotsEntityStoreSerializerImpl(final LongFunction<ByteBuffer> bufferFinder, final LongToIntFunction offsetFinder) {
        this.bufferFinder = requireNonNull(bufferFinder);
        this.offsetFinder = requireNonNull(offsetFinder);
    }
    
    @Override
    public BiConsumer<ByteBuffer, ParkingLots> serializer() {
        return (buffer, entity) -> {
            ...
            if (entity.getStatus().isPresent()) {
                buffer.putInt(VARSIZE_BEGINS + varSizePos, entity.getStatus().getAsInt());
                varSizePos += Integer.BYTES;
                buffer.put(ENDPOS_STATUS, (byte) varSizePos);
            } else {
                buffer.put(ENDPOS_STATUS, (byte) (0x80 | varSizePos));
            }
    ...
    public LongFunction<ParkingLots> deserializer() {
        return ref -> {
            ...
            if (buffer.get(offset + ENDPOS_STATUS) >= 0) {
                entity.setStatus(buffer.getInt(offset + VARSIZE_BEGINS + buffer.get(offset + ENDPOS_STATUS) - Integer.BYTES));
            }
    ...
    @Override
    public Class<?> deserializedType(final ColumnIdentifier<ParkingLots> colId) {
        if (colId instanceof ParkingLots.Identifier) {
            final ParkingLots.Identifier _id = (ParkingLots.Identifier) colId;
            switch (_id) {
                case ID         : return long.class;
                case LOT_NUMBER : 
                case STATUS     : return int.class;
    ...
    @Override
    public <FK_ENTITY> LongUnaryOperator finder(final ColumnIdentifier<ParkingLots> colId, final ColumnIdentifier<FK_ENTITY> fkColId) {
        return finder(singletonList(colId), singletonList(fkColId));
    }
    
    @Override
    public <FK_ENTITY> LongUnaryOperator finder(final List<ColumnIdentifier<ParkingLots>> cols, final List<ColumnIdentifier<FK_ENTITY>> fkCols) {
        throw new UnsupportedOperationException("ParkingLots has no foreign references.");
    }
    ...
    @Override
    public LongPredicate isNull(final ColumnIdentifier<ParkingLots> colId) {
        if (colId instanceof ParkingLots.Identifier) {
            final ParkingLots.Identifier _id = (ParkingLots.Identifier) colId;
            switch (_id) {
                ...
                case STATUS     : return ref -> bufferFinder.apply(ref).get(offsetFinder.applyAsInt(ref) + ENDPOS_STATUS) < 0;
    ...
    @Override
    public LongPredicate isPresent(final ColumnIdentifier<ParkingLots> colId) {
        if (colId instanceof ParkingLots.Identifier) {
            final ParkingLots.Identifier _id = (ParkingLots.Identifier) colId;
            switch (_id) {
    ...
    @Override
    public LongToByteFunction byteDeserializer(final ColumnIdentifier<ParkingLots> colId) {
        throw new UnsupportedOperationException(
    ...
    @Override
    public LongToShortFunction shortDeserializer(final ColumnIdentifier<ParkingLots> colId) {
        throw new UnsupportedOperationException(
    ...
    @Override
    public LongToIntFunction intDeserializer(final ColumnIdentifier<ParkingLots> colId) {
        if (colId instanceof ParkingLots.Identifier) {
            final ParkingLots.Identifier _id = (ParkingLots.Identifier) colId;
            switch (_id) {
                ...
                case STATUS     : return ref -> {
                    final ByteBuffer buffer = bufferFinder.apply(ref);
                    final int offset = offsetFinder.applyAsInt(ref);
                    return buffer.getInt(offset + VARSIZE_BEGINS + buffer.get(offset + ENDPOS_STATUS) - Integer.BYTES);
                };
                default : {
                    throw new UnsupportedOperationException(
    ...
    @Override
    public LongUnaryOperator longDeserializer(final ColumnIdentifier<ParkingLots> colId) {
    ...
    @Override
    public LongToFloatFunction floatDeserializer(final ColumnIdentifier<ParkingLots> colId) {
        throw new UnsupportedOperationException(
    ...
    @Override
    public LongToDoubleFunction doubleDeserializer(final ColumnIdentifier<ParkingLots> colId) {
        throw new UnsupportedOperationException(
    ...
    @Override
    public LongToCharFunction charDeserializer(final ColumnIdentifier<ParkingLots> colId) {
        throw new UnsupportedOperationException(
    ...
    @Override
    public LongToBooleanFunction booleanDeserializer(final ColumnIdentifier<ParkingLots> colId) {
        throw new UnsupportedOperationException(
    ...
    @Override
    public LongFunction<?> objectDeserializer(final ColumnIdentifier<ParkingLots> colId) {
    ...
    @Override
    public BiLongToIntFunction comparator(final ColumnIdentifier<ParkingLots> colId) {
        if (colId instanceof ParkingLots.Identifier) {
            final ParkingLots.Identifier _id = (ParkingLots.Identifier) colId;
            switch (_id) {
                ...
                case STATUS     : return (aRef, bRef) -> {
                    ...
                    final int bOffset = offsetFinder.applyAsInt(bRef);
                    return Integer.compare(
                        aBuf.getInt(aOffset + VARSIZE_BEGINS + aBuf.get(aOffset + ENDPOS_STATUS) - Integer.BYTES),
                        bBuf.getInt(bOffset + VARSIZE_BEGINS + bBuf.get(bOffset + ENDPOS_STATUS) - Integer.BYTES)
                    );
                };
    ...
    @Override
    public BiLongToIntFunction comparatorNullsLast(final ColumnIdentifier<ParkingLots> colId) {
        if (colId instanceof ParkingLots.Identifier) {
            final ParkingLots.Identifier _id = (ParkingLots.Identifier) colId;
            switch (_id) {
                case ID         : return (aRef, bRef) -> Long.compare(
                ...
                case STATUS     : return (aRef, bRef) -> {
                    ...
                    final int aOffset = offsetFinder.applyAsInt(aRef);
                    final int bOffset = offsetFinder.applyAsInt(bRef);
                    final int aEndPos = aBuf.get(aOffset + ENDPOS_STATUS);
                    final int bEndPos = bBuf.get(bOffset + ENDPOS_STATUS);
                    if (aEndPos < 0 && bEndPos < 0) return 0;
                    else if (aEndPos < 0) return 1;
                    else if (bEndPos < 0) return -1;
                    else return Integer.compare(
    ...
    @Override
    public LongToIntFunction compareToByte(final ColumnIdentifier<ParkingLots> colId, final byte value) {
        throw new UnsupportedOperationException(
            String.format("The column '%s' is either unknown or not of type byte.", colId.getColumnId())
        );
    }
    ...
    @Override
    public LongToIntFunction compareToShort(final ColumnIdentifier<ParkingLots> colId, final short value) {
        throw new UnsupportedOperationException(
            String.format("The column '%s' is either unknown or not of type short.", colId.getColumnId())
        );
    }
    ...
    @Override
    public LongToIntFunction compareToInt(final ColumnIdentifier<ParkingLots> colId, final int value) {
        if (colId instanceof ParkingLots.Identifier) {
            final ParkingLots.Identifier _id = (ParkingLots.Identifier) colId;
            switch (_id) {
                case LOT_NUMBER : {
                ...
                case STATUS     : {
                    ...
                    return ref -> {
                        final ByteBuffer buffer = bufferFinder.apply(ref);
                        final int offset = offsetFinder.applyAsInt(ref);
                        final int endPos = buffer.get(offset + ENDPOS_STATUS);
                        if (endPos < 0) return 1;
                        else return Integer.compare(
                            buffer.getInt(offset + VARSIZE_BEGINS + endPos - Integer.BYTES),
                            operand
    ...
    @Override
    public LongToIntFunction compareToLong(final ColumnIdentifier<ParkingLots> colId, final long value) {
        if ("id".equals(colId.getColumnId())) {
            {
    ...
    @Override
    public LongToIntFunction compareToFloat(final ColumnIdentifier<ParkingLots> colId, final float value) {
        throw new UnsupportedOperationException(
            String.format("The column '%s' is either unknown or not of type float.", colId.getColumnId())
        );
    }
    ...
    @Override
    public LongToIntFunction compareToDouble(final ColumnIdentifier<ParkingLots> colId, final double value) {
        throw new UnsupportedOperationException(
            String.format("The column '%s' is either unknown or not of type double.", colId.getColumnId())
        );
    }
    ...
    @Override
    public LongToIntFunction compareToBoolean(final ColumnIdentifier<ParkingLots> colId, final boolean value) {
        throw new UnsupportedOperationException(
            String.format("The column '%s' is either unknown or not of type boolean.", colId.getColumnId())
        );
    }
    ...
    @Override
    public LongToIntFunction compareToChar(final ColumnIdentifier<ParkingLots> colId, final char value) {
        throw new UnsupportedOperationException(
            String.format("The column '%s' is either unknown or not of type char.", colId.getColumnId())
        );
    }
    ...
    @Override
    public LongToIntFunction compareToObject(final ColumnIdentifier<ParkingLots> colId, final Object value) {
        if ("updated_at".equals(colId.getColumnId())) {
            {
    ...
    @Override
    public LongToIntFunction compareToNull(final ColumnIdentifier<ParkingLots> colId) {
        if (colId instanceof ParkingLots.Identifier) {
            final ParkingLots.Identifier _id = (ParkingLots.Identifier) colId;
            switch (_id) {
                ...
                case STATUS     : return ref -> {
                    final ByteBuffer buffer = bufferFinder.apply(ref);
                    final int offset = offsetFinder.applyAsInt(ref);
                    return buffer.get(offset + ENDPOS_STATUS) < 0 ? 0 : -1;
                };
    ...
    @Override
    public LongPredicate newPredicate(final ColumnIdentifier<ParkingLots> colId, final EntityStorePredicate predicate) {
        if (colId instanceof ParkingLots.Identifier) {
            final ParkingLots.Identifier _id = (ParkingLots.Identifier) colId;
            switch (_id) {
                case ID         : return ref -> {
                ...
                case STATUS     : return ref -> {
                    ...
                    final int rowOffset = offsetFinder.applyAsInt(ref);
                    return predicate.test(buffer,
                        rowOffset + VARSIZE_BEGINS + (0x7f & buffer.get(rowOffset + ENDPOS_STATUS - Byte.BYTES)),
                        rowOffset + VARSIZE_BEGINS + buffer.get(rowOffset + ENDPOS_STATUS)
                    );
                };
                case UPDATED_AT : return ref -> {
                    final ByteBuffer buffer = bufferFinder.apply(ref);
    ...
    @Override
    public LongToIntFunction newCompareTo(final ColumnIdentifier<ParkingLots> colId, final EntityStoreCompareTo compareTo) {
        if (colId instanceof ParkingLots.Identifier) {
            final ParkingLots.Identifier _id = (ParkingLots.Identifier) colId;
            switch (_id) {
                case ID         : return ref -> {
    ...
    @Override
    public BiLongToIntFunction newComparator(final ColumnIdentifier<ParkingLots> colId, final EntityStoreComparator comparator) {
        if (colId instanceof ParkingLots.Identifier) {
            final ParkingLots.Identifier _id = (ParkingLots.Identifier) colId;
            switch (_id) {
                ...
                case STATUS     : return (aRef, bRef) -> {
                    ...
                    final int bRowOffset = offsetFinder.applyAsInt(bRef);
                    return comparator.compare(
                        aBuffer, aRowOffset + VARSIZE_BEGINS + (0x7f & aBuffer.get(aRowOffset + ENDPOS_STATUS - Byte.BYTES)), aRowOffset + VARSIZE_BEGINS + aBuffer.get(aRowOffset + ENDPOS_STATUS), 
                        bBuffer, bRowOffset + VARSIZE_BEGINS + (0x7f & bBuffer.get(bRowOffset + ENDPOS_STATUS - Byte.BYTES)), bRowOffset + VARSIZE_BEGINS + bBuffer.get(bRowOffset + ENDPOS_STATUS)
                    );
                };
                case UPDATED_AT : return (aRef, bRef) -> {
                    final ByteBuffer aBuffer = bufferFinder.apply(aRef);
